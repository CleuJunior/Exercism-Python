...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    power_output_range = int((generated_power / theoretical_max_power) * 100)
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature_neutrons_per_second < threshold * 0.9:
        return 'LOW'

    if temperature_neutrons_per_second > threshold * 1.1:
        return 'DANGER'
